...
USER_BOT_NO_WARN = ("`Hello, This is ⚜GODZILLA BOT⚜.You have found your way here to my master,`"
                    
                   f"{DEFAULTUSER}'s `inbox. My Boss must be busy now, he will reply when he be available..\n"

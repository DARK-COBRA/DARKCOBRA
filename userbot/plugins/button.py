...
CMD_HELP.update({
    ...
    \n**EXAMPLE :** `.cbutton test [google]<buttonurl:https://www.google.com> [BarkCobra]<buttonurl:https://t.me/Dark_cobra_support:same> [support]<buttonurl:https://t.me/Dark_cobra_support_group>`\
    "
})

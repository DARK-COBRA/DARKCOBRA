...
IS_SELECTED_DIFFERENT_BRANCH = (
    "Looks Like Using A Custom Branch {branch_name} "
    "Is Being Used:\n"
    "Now My Updater Is Unable Update\n"
    "Plz Repdeploy For Latest Updates."
)
OFFICIAL_UPSTREAM_REPO = "https://github.com/DARK-COBRA/DARKCOBRA"
BOT_IS_UP_TO_DATE = "`Master I Am in The Latest Version.\nThank you for Using this Service.`"
...
NO_HEROKU_APP_CFGD = "Master Where is Heroku API Key ??? 😕 "
HEROKU_GIT_REF_SPEC = "HEAD:refs/heads/master"
RESTARTING_APP = "Wait A 2 Min Just Restarting the App"
# -- Constants End -- #
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("`DarkCobra Updation in Progress......`")

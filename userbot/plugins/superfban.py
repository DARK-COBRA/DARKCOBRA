...
# By TELEBOT
# Ported from telebot for DC by @hellboi_atul
...
async def _(event):
    ...
    try:
        int(FBAN)
        if int(FBAN) == 803243487 or int(FBAN) == 1289422521:
            await event.edit("You can't ban him..")
            return
    except BaseException:
        if FBAN == "@hellboi_atul" or FBAN == "@hellboi_atul31":
            await event.edit("You can't ban him..")
            return
